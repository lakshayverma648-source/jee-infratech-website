          ...
          <div className="container flex items-center justify-between h-full">
            <h1>
              <Link href="/" className="logo flex items-center gap-3">
                <Image width={1000} height={1000} src="/images/logo_orange.png" className="flex-shrink-0 w-10" alt="logo" />
                <strong className="heading4">Jee Infratech Solutions</strong>
              </Link>
            </h1>
            <ul className="header_info flex items-center xl:gap-15 gap-5">
              ...
              <li className="flex items-center gap-3">
                <Link href="mailto:purchase@jeeinfratechsolutions.com" className="flex items-center gap-3 group">
                  <span
                    className="flex items-center justify-center sm:w-14 w-12 sm:h-14 h-12 border-2 border-orange duration-400 group-hover:bg-orange group-hover:text-white">
                  ...
                  <div className="max-lg:hidden">
                    ...
                    <strong className="heading6 block mt-0.5">purchase@jeeinfratechsolutions.com</strong>
                  </div>
                </Link>
              </li>
