      ...
      <div className="container flex flex-wrap justify-between gap-10">
        <div className="footer_info md:w-1/4 w-full">
          ...
          <div className="footer_map mt-7">
            ...
            {/* <Link href="" className="text-sm font-bold underline duration-300 hover:text-orange" target="_blank">Google map</Link> */}
          </div>
          <div className="footer_mail flex flex-wrap items-center gap-2 mt-4">
           ...
           <div className="footer_mail flex flex-wrap items-center gap-2 mt-4">
            <Icon.Envelope className="text-2xl" />
            <span>opearations@jeeinfratechsolutions.com</span>
          </div>
          <div className="footer_time mt-4">
            <span className="block pb-1 text-variant2">Timings:</span>
            <span className="block">Mon - Sun: 10am - 08pm</span>
          ...
          <div className="footer_nav flex max-xl:flex-wrap justify-between gap-10 gap-y-6 mt-10">
            <div className="footer_nav_area max-sm:w-full">
              ...
              <ul className="footer_nav_list flex flex-col gap-2 mt-3">
                ...
                <li>
                  <Link href="shop/our-products" className="footer_nav_link has_line line_white capitalize text-variant2 hover:text-white duration-300">Products</Link>
                </li>
                 <li>
            ...
            {/* <div className="footer_nav_area max-sm:w-full">
              ...
              <ul className="footer_nav_list flex flex-col gap-2 mt-3">
                ...
                <li>
                  <Link href="/pages/our-products" className="footer_nav_link has_line line_white capitalize text-variant2 hover:text-white duration-300">Shop</Link>
                </li>
                <li>
            ...
            <div className="footer_nav_area max-md:w-full">
              ...
              <Link href="/contact" className={`btn mt-4 bg-${color} hover:bg-white`}>Request an estimate</Link>
            </div>
          </div>
        </div>
        <div className="footer_bottom flex items-center justify-between max-sm:flex-col gap-2 w-full mt-5 py-4 border-t border-white border-opacity-10">
          <p className="copyright text-variant2 text-center">Copyright © 2026 Jee Infratech Solutions<Link href="#!" className="text-white hover:underline" target="_blank"></Link>. <br className="xs:hidden" /></p>
          <div className="footer_bottom_link flex items-center gap-2.5">
            <Link className="text-variant2 hover:underline hover:text-white" href="#!">All rights reserved</Link>
