        ...
        <section className="section choose_us sm:pt-25 pt-15">
            <div className="container flex max-xl:flex-col gap-y-10">
                <div className="choose_us_content w-full xl:pr-20">
                    ...
                    <h3 className="section_tit mt-4 heading3 animate">Trusted Civil & Facility Services You Can Rely On</h3>
                    <p className="section_desc lg:mt-5 mt-3 body2 text-variant1 animate">Our experienced team delivers reliable civil, maintenance, and facility services—from execution to ongoing support—ensuring efficient performance, quality workmanship, and dependable solutions for commercial and residential projects.</p>
