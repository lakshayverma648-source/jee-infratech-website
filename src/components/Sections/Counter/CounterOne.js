                ...
                <div className="container">
                    <div className="flex max-md:flex-col items-center md:justify-end relative bg-white">
                        <div
                            ...
                            <Image width={3000} height={3000} src="/images/components/counter1.jpg" className="h-full object-cover animate animate_left" alt="Book Our Expert  Today!" />
                            <div className="banner_area animate animate_right" style={{ "--i": 1 }}>
                                <Link href="tel:+91 9310125253" className="banner_link flex items-center gap-4 absolute right-0 bottom-0 p-5 bg-dark text-white duration-400 group hover:bg-orange">
                                    <span
                                    ...
                                    <span>
                                        ...
                                        <strong className="block heading4 mt-1 max-md:text-2xl">+91 9310125253</strong>
                                    </span>
                                </Link>
                            </div>
                        </div>
                        <div
                            ...
                            <h3 className="section_tit mt-4 heading3 animate">Book Our Expert Today!</h3>
                            <p className="section_desc lg:mt-5 mt-3 body2 text-variant1 animate">From civil and plumbing work to electrical, painting, and facility services, our skilled professionals handle all your repair, maintenance, and modification needs with precision and reliability. Schedule your service today.</p>
